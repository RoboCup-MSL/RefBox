...
#include "musashi_msgs/msg/detail/referee_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const musashi_msgs::msg::RefereeCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  musashi_msgs::msg::RefereeCmd & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = musashi_msgs::msg::RefereeCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const musashi_msgs::msg::RefereeCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<musashi_msgs::msg::RefereeCmd *>(
    untyped_ros_message);
...
{
  return &musashi_msgs::msg::typesupport_fastrtps_cpp::_RefereeCmd__handle;
}
