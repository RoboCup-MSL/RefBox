...
static const _MotorStates_type_support_symbol_names_t _MotorStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musashi_msgs, msg, MotorStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, musashi_msgs, msg, MotorStates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, musashi_msgs, msg, MotorStates)() {
  return &::musashi_msgs::msg::rosidl_typesupport_c::MotorStates_message_type_support_handle;
}
