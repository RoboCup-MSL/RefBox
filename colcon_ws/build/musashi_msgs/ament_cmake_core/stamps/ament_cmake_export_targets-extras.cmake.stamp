...
if(NOT _exported_targets STREQUAL "")
  foreach(_target ${_exported_targets})
    ...
    list(APPEND musashi_msgs_TARGETS ${_targets})
  endforeach()
endif()
