...
#include "musashi_msgs/msg/detail/motor_states__rosidl_typesupport_fastrtps_c.h"
...
#include "musashi_msgs/msg/detail/motor_state__functions.h"  // states
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_musashi_msgs__msg__MotorState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_musashi_msgs__msg__MotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musashi_msgs, msg, MotorState)();
...
using _MotorStates__ros_msg_type = musashi_msgs__msg__MotorStates;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: states
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, musashi_msgs, msg, MotorState
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      musashi_msgs__msg__MotorState__Sequence__fini(&ros_message->states);
    }
    if (!musashi_msgs__msg__MotorState__Sequence__init(&ros_message->states, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_musashi_msgs__msg__MotorState(
...
static uint32_t _MotorStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_musashi_msgs__msg__MotorStates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_musashi_msgs
size_t max_serialized_size_musashi_msgs__msg__MotorStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_musashi_msgs__msg__MotorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = musashi_msgs__msg__MotorStates;
    is_plain =
      (
...
static size_t _MotorStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_musashi_msgs__msg__MotorStates(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, musashi_msgs, msg, MotorStates)() {
