...
class RefereeCmd(metaclass=Metaclass_RefereeCmd):
    ...
    def __init__(self, **kwargs):
        ...
        self.target_team = kwargs.get('target_team', str())
    ...
    def __eq__(self, other):
        ...
        if self.command != other.command:
            return False
        if self.target_team != other.target_team:
            return False
        return True
    ...
    def target_team(self):
        """Message field 'target_team'."""
        return self._target_team

    @target_team.setter
    def target_team(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'target_team' field must be of type 'str'"
        self._target_team = value
