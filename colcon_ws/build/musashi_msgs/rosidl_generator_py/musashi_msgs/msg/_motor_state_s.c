...
bool musashi_msgs__msg__motor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("musashi_msgs.msg._motor_state.MotorState", full_classname_dest, 40) == 0);
  }
  musashi_msgs__msg__MotorState * ros_message = _ros_message;
  {  // header
...
PyObject * musashi_msgs__msg__motor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("musashi_msgs.msg._motor_state");
