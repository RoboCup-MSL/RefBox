...
public static Button bTeamAcolor;
public static Button bTeamBcolor;
public static color colorAteam=#00ffff;
public static color colorBteam=#ff00ff;
...
void draw() {
  ...
  changeTeamAColor(colorAteam);
  changeTeamBColor(colorBteam);
  long t1=getGameTime();
  ...
  bTeamAcolor.update(); //chanege de color team
  bTeamBcolor.update();//chanege de color team
...
void initGui()
{
  ...
  bTeamAcolor = new Button(162, 63, "", -1,-1,-1,-1);
  bTeamAcolor.cmd = "Change Color Team";
  bTeamAcolor.setdim(305, 126); 
  bTeamBcolor = new Button(832, 63, "", -1,-1,-1,-1);
  bTeamBcolor.cmd = "Change Color Team";
  bTeamBcolor.setdim(305, 126); 
...
void changeTeamAColor(color type)
{

  fill(type);
  rectMode(CORNER);
  rect(13, 2, 305, 126, 0, 0, 15, 0);
  teamA.c=colorAteam;
}
void changeTeamBColor(color type)
{

  fill(type);
  rectMode(CORNER);
  rect(682, 2, 305, 126, 0, 0, 0, 15);
  teamB.c=colorBteam;
}
